...
const configData: Config = {
  name: "Tabsy Coffee",
  tagline: "Artisan roasted coffee and fresh pastries.",
  ...
  seo: {
    title: "Tabsy Coffee | Premium Halal Meats & Groceries | Online Ordering",
    description: "Shop Tabsy Coffee for premium halal meats and groceries. Artisan roasted coffee and fresh pastries. Order online for pickup or delivery today.",
    keywords: "halal meat, halal grocery, online ordering, food delivery, pickup, fresh market, halal butcher, naperville, shahirizada"
  },
  announcement: "☕️ Try our new seasonal Pumpkin Spice Latte!",
  newsletter: true,
  loyalty: {
    enabled: true,
    earnPerDollar: 10,
